package ru.JavaRush.JavaCore.LvL20.lec2.Sol2;
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if (users.size() == 0) {
                while (reader.ready()) {
                    ...
                    for (User.Country isCountry : countries) {
                        if (country.equals(isCountry.getDisplayName())) {
                            user.setCountry(isCountry);
                            break;
                        }
                    }
                    users.add(user);
...
//Сто процентная ошибка. Валидатор хочет видеть секунды а не SimpleDate
//вам метод для save
