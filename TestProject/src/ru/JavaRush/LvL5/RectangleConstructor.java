...
public class RectangleConstructor {
    ...
    public RectangleConstructor(int top, int left, int width, int height) {
        this.top = top;
        this.left = left;
        this.width = width;
        this.height = height;
    ...
    public RectangleConstructor(int top, int left) {
        this.top = top;
        this.left = left;
    }

    public RectangleConstructor(int top, int left, int width) {
        this.top = top;
        this.left = left;
        this.width = width;
    }

    public RectangleConstructor(RectangleConstructor rectangleConstructor) {
    }
}
