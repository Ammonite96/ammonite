package ru.JavaRush.JavaMultithreading.LvL24.lec9.sol3;
...
public class Solution {
    ...
    public static class Stock extends HashMap<String, Object> {
        ...
        public Double profit(){
            if (this.containsKey("open")){
                return (double) this.get("last") - (double) this.get("open");
            } else return (double) this.get("change");
        }
    }
